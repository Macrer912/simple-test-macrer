...
function toggleTarget() {
    ...
    function arte2() {
      ...
      const manequimmanga = document.getElementById("manequimangaD");
      ...
      manequim2.setAttribute("filter", "url(#filter-fffff)");
      manequim3.setAttribute("xlink:href", "img/artes/artes/B3.png");
      manequim3.setAttribute("filter", "url(#filter-000000)");
      ...
      manequimcosta2.setAttribute("filter", "url(#filter-ffffff)");
      manequimcosta3.setAttribute("xlink:href", "img/artes/artes/B3T.png");
      manequimcosta3.setAttribute("filter", "url(#filter-000000)");
      
      manequimmangad.setAttribute("xlink:href", "img/artes/artes/B1.png");
      manequimmangad.setAttribute("filter", "url(#filter-000000)");
      manequimmangad2.setAttribute("xlink:href", "img/artes/artes/B2.png");
      manequimmangad2.setAttribute("filter", "url(#filter-000000)");
      manequimmangad3.setAttribute("xlink:href", "img/artes/artes/B2CALCAO.png");
      manequimmangad3.setAttribute("filter", "url(#filter-ffffff)");
      
      
      
      document.getElementById("manequimanga").setAttribute("xlink:href", "img/artes/artes/BMANGA.png");
      document.getElementById("manequimanga2").setAttribute("xlink:href", "img/artes/artes/B2.png");
      document.getElementById("manequimanga3").setAttribute("xlink:href", "img/artes/artes/B2CALCAO.png");
      document.getElementById("manequimangaT").setAttribute("xlink:href", "img/artes/artes/BMANGA.png");
      document.getElementById("manequimanga2T").setAttribute("xlink:href", "img/artes/artes/B2.png");
      document.getElementById("manequimanga3T").setAttribute("xlink:href", "img/artes/artes/B2CALCAO.png");
      document.getElementById("manequimangaDT").setAttribute("xlink:href", "img/artes/artes/BMANGA.png");
      document.getElementById("manequimangaD2T").setAttribute("xlink:href", "img/artes/artes/B2.png");
      document.getElementById("manequimangaD3T").setAttribute("xlink:href", "img/artes/artes/B2CALCAO.png");
    ...
    function arte1() {
      document.getElementById("manequim").setAttribute("xlink:href", "img/artes/artes/A1.png");
      document.getElementById("manequim2").setAttribute("xlink:href", "img/artes/artes/A2.png");
      
      document.getElementById("manequim3").setAttribute("xlink:href", "img/artes/artes/A3.png");
       document.getElementById("manequimcosta").setAttribute("xlink:href", "img/artes/artes/A1T.png");
      document.getElementById("manequimcosta2").setAttribute("xlink:href", "img/artes/artes/A2T.png");
      document.getElementById("manequimcosta3").setAttribute("xlink:href", "img/artes/artes/A3T.png");
      document.getElementById("manequimangaD").setAttribute("xlink:href", "img/artes/artes/AMANGAD1.png");
      document.getElementById("manequimangaD2").setAttribute("xlink:href", "img/artes/artes/AMANGAD2.png");
      document.getElementById("manequimangaD3").setAttribute("xlink:href", "img/artes/artes/AMANGAD3.png");
      document.getElementById("manequimanga").setAttribute("xlink:href", "img/artes/artes/AMANGA1.png");
      document.getElementById("manequimanga2").setAttribute("xlink:href", "img/artes/artes/AMANGA2.png");
      document.getElementById("manequimanga3").setAttribute("xlink:href", "img/artes/artes/AMANGA3.png");
      document.getElementById("manequimangaT").setAttribute("xlink:href", "img/artes/artes/AMANGA1.png");
      document.getElementById("manequimanga2T").setAttribute("xlink:href", "img/artes/artes/AMANGA2.png");
      document.getElementById("manequimanga3T").setAttribute("xlink:href", "img/artes/artes/AMANGA3.png");
      document.getElementById("manequimangaDT").setAttribute("xlink:href", "img/artes/artes/AMANGAD1.png");
      document.getElementById("manequimangaD2T").setAttribute("xlink:href", "img/artes/artes/AMANGAD2.png");
      document.getElementById("manequimangaD3T").setAttribute("xlink:href", "img/artes/artes/AMANGAD3.png");
